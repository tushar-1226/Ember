...
- **Supervisor Agent Architecture**: A robust LangGraph-based backend orchestrating specialized AI tasks and dynamic routing.
- **Project-Centric Workspace**: Fully scoped chat sessions with dynamic frontend routing for managing separate projects.
