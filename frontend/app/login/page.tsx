    ...
    >
      ...
      >
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-between">
              ...
              <Link href="#" className="text-xs text-muted hover:text-ember-amber transition-colors">
                Forgot password?
              </Link>
            </div>
            <input
        ...
        <p className="mt-8 text-center text-sm text-muted">
          ...
          <Link href="/signup" className="font-medium text-ember-amber hover:underline">
            Sign up
          </Link>
        </p>
        </motion.div>
